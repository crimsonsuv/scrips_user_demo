            ...
            if (state is ErrorState) {
              ...
              formData.items.forEach((element) {
                ...
                element.items.forEach((element1) {
                  subitems.add(QuestionnaireResponse.Item(
                      questionId: element1.id,
                      linkId: element1.linkId,
                      text: element1.text,
                      type: element1.type,
                      answer: QuestionnaireResponse.Answer(
                          valueBoolean: null, valueString: "", valueCoding: []),
                      items: []));
                });
                items.add(QuestionnaireResponse.Item(
              ...
              response = QuestionnaireResponse.QuestionnaireResponse(
                  ...
                  subject: widget.patientId,
                  author: formData.practitionerId,
                  items: items);
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  children: <Widget>[
                                                    ...
                                                    Text(
                                                      "Please, complete this check-in form before your \nvisit at 5:30 PM on May 30, 2020. ",
                                                      style:
                                ...
                                (formData?.id == null)
                                    ...
                                    : Padding(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 16),
                                        child: Text(
                                          "${formData?.items?.length ?? 0} QUESTIONS ADDED",
                                          style: boldLabelTextStyle(
                                              12, textInputColor),
                                        ),
                                      ),

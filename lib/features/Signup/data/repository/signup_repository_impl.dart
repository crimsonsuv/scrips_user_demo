...
class SignupRepositoryImpl extends SignupRepository {
  ...
  @override
  Future<Either<Failure, List<PatientList>>> getPatient({String firstName, String lastName, String email, String contactNumber, DateTime dob, String gender}) async{
    try {
      final result = await signupDataSource.getPatient(firstName: firstName, lastName: lastName, contactNumber: contactNumber, dob: dob, gender: gender, email: email);
      return Right(result);
    } on DioError catch (e) {
